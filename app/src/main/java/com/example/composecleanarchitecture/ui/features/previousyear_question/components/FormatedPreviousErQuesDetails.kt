...
@Composable
fun FormatedPreviousErQuesDetails(
    quesIndex: Int,
    attributes: PreviousYearQuestionDetailsFormat,
    selectedPosition: AnswerTrackingState?,
    onAnswerGiven: (isGiven: Boolean, answerValue: Int, AnswerTrackingState) -> Unit
) {
    val rightAnswer = attributes.answer?.uppercase()
    ...
    Column(
            ...
            Column {
                ...
                DropdownMenu(
                    ...
                    DropdownMenuItem(text = {
                        Text(
                            "Issue of this question or answer.", color = blackVarColor1
                        )
        ...
        Row(
            ...
            Column {
                ...
                CustomTextComponents(
                    title = ". ${attributes.organizationName}",
                    fontWeight = FontWeight.W400,
                    textSize = 6.sp,
                    textColor = questionDetailsTextColor,
                    textAlign = TextAlign.Start
            ...
            Column {
                CustomTextComponents(
                    title = ". গ্রেডঃ ${attributes.gradeName}",
                    fontWeight = FontWeight.W400,
                    textSize = 6.sp,
                    textColor = questionDetailsTextColor,
                    textAlign = TextAlign.Start
                ...
                CustomTextComponents(
                    title = ". পদবিঃ ${attributes.designationName}",
                    fontWeight = FontWeight.W400,
                    textSize = 6.sp,
                    textColor = questionDetailsTextColor,
                    textAlign = TextAlign.Start
        ...
        if (!attributes.optionE.isNullOrEmpty() || attributes.optionE != "") {
            Spacer(modifier = Modifier.height(10.dp))
            OutlineBorderWithText(
                "E",
                " ${attributes.optionE}",
        ...
        if (isAnswerGiven) {
            Box(modifier = Modifier.padding(start = 20.dp, end = 20.dp)) {
                QuestionDetailsExplanationComponents("${attributes.details}")
            }
        }
        Spacer(modifier = Modifier.height(10.dp))
    }
