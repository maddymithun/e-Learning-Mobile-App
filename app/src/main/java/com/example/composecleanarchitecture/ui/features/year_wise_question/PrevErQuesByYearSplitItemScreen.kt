...
import com.example.composecleanarchitecture.view_models.year_wise_question.YearWiseQuestionViewModel
import com.google.gson.Gson

@Composable
fun PrevErQuesByYearSplitItemScreen(
    viewModel: SharedViewModel,
    year: String,
    navController: NavController
) {
    val previousErQusViewModel: YearWiseQuestionViewModel = hiltViewModel()
    ...
    val questionDatItem: LazyPagingItems<FormatQuestionsAsExpected> =
        previousErQusViewModel.getPreviousYearQuestionsByYear(year)
