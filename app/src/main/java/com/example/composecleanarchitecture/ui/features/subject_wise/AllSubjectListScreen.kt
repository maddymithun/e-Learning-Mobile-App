...
import com.example.composecleanarchitecture.ui.features.subject_wise.components.SubjectCategoryCardComponent
                ...
                items(
                    ...
                    Box(modifier = Modifier.clickable {
                        item?.let {
                            ...
                            if ((preferencesHelper["$TOPICS_OF_SUBJECT_CATEGORY$code", ""] == "1" && !context.isInternetAvailable()) or context.isInternetAvailable()) {
                                navController.navigate("AllTopicsListScreen/$code")
                            } else {
